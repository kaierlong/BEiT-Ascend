...
def parse_arguments():
    """parse_arguments"""
    global args
    parser = argparse.ArgumentParser(description="MindSpore Beit Training")

    parser.add_argument("-a", "--arch", metavar="ARCH", default="beit_base_patch16_224_pt22k_ft22k",
    ...
    parser.add_argument("--best_every", type=int, default=5, help="Move model best every epochs(default:10)")
    parser.add_argument("--save_every", type=int, default=10, help="Save model ckpt every epochs(default:100)")
    ...
    parser.add_argument('--ckpt_url', type=str, default="", help='pretrain model path')
    parser.add_argument('--multi_data_url', type=str, default="", help='multi datasets url')
...
def get_config():
    ...
    print(f"=> Reading YAML config from {args.config_file}", flush=True)
